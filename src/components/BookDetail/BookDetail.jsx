...
const BookDetail = () => {
  ...
  return (
    <div className="mb-[100px]">
      <div className="grid grid-cols-2 gap-[48px] h-[710px] mb-[50px]">
        ...
        <div>
          ...
          <p className="my-4 text-[20px] font-medium text-[#131313CC]">
            By: {author}
          </p>
          <hr />
          <p className="my-4 text-[20px] font-medium text-[#131313CC]">
          ...
          <div className="mt-8">
            <button
              ...
              className="px-[28px] py-[18px] text-[18px] hover:bg-[#50B1C9] hover:text-white font-semibold border-[#50B1C9] rounded-[8px] border"
            >
              Read
            </button>
            <button
              onClick={() => handleAddWishList(bookId)}
              className="px-[28px] text-[18px] border-[#50B1C9] hover:bg-[#50B1C9] hover:text-white font-semibold ml-4 py-[18px] rounded-[8px] border"
            >
              Wishlist
            </button>
          </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          className="bg-[#23BE0A] px-[28px] rounded-[16px] text-white font-semibold text-[18px] py-[14px]"
        >
          Go Back
        </button>
      </div>
